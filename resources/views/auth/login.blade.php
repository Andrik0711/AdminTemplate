...
@section('content')
    <div class="flex justify-center">
        {{-- Este es para el formu de login --}}
        <div class=" xl:max-sm">

            <div class="my-20 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <h2
        ...
        <div class="flex align-middle">
            <div class="max-w-xs transform duration-200 hover:scale-110 cursor-pointer flex align-middle">
