        ...
        <div class=" md:w-1/2 bg-white p-6 rounded-lg shadow-xl">
            ...
            <form action="#" method="#">
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <label for="empresa_emisora" class="mb-2 uppercase font-bold text-lg text-grey-darkest">Empresa
                        emisora</label>
                ...
                <div class="flex flex-col mb-4">
                    {{-- Campo RFC RECEPTOR --}}
                    <label for="rfc_receptor" class="mb-2 uppercase font-bold text-lg text-grey-darkest">RFC
                        RECEPTOR</label>
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <label for="razon_social" class="mb-2 uppercase font-bold text-lg text-grey-darkest">Razon social
                        *(Receptor) </label>
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <label for="folio_factura" class="mb-2 uppercase font-bold text-lg text-grey-darkest">Folio de
                        factura</label>
                ...
                {{-- Boton de busqueda --}}
                <button type="submit" class="bg-blue-500 text-white px-4 py-3 rounded font-medium w-full">Buscar</button>
            </form>
        </div>
    </div>
@endsection
